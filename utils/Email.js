...
class Email {
  constructor(user, otp) {
    ...
    this.from = "no-reply@aaoochale.com"; //process.env.EMAIL_FROM;
  }
  newTransporter() {
    return nodemailer.createTransport({
      ...
      auth: {
        user: "aaoochale@gmail.com", // process.env.EMAIL_FROM,no-reply@aaoochale.com
        pass: "wodqckbohyzkboae", // Akhilesh@11
      },
      from: "no-reply@aaoochale.com", // process.env.EMAIL_FROM, // aaochale.gmail.com,
    });
  }
